<script>
    ...
    function modalRetiraDoc(idDoc) {
        $('#idDoc').val(idDoc)
        $("#modalretiraDocumentos").modal('show')
    }

    function verificarCampos(){
        if($('#justificativa').val() == ''){
            return msgWarning('Informe a justificativa')
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response[0]["status"] == true) {
                        $('#modalretiraDocumentos').modal('hide')
                ...
                error: function (response) {
                    $('#modalretiraDocumentos').modal('hide')
                    $("button").attr("disabled", false);
                    msgErro('Não foi possível retirar o arquivo !')
                    $('#tabelaDocumentos').DataTable().ajax.reload();
                    cachePagina(pagina)
                }
            })
